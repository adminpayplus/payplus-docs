...
flowchart TD
    ...
    C["Work Command Language<br/>Command interface"]
...
| Founder work-command meaning and lifecycle routing | [PayPlus Work Command Language](payplus-work-command-language.md) | Lifecycle stages or gates, approval authority, subject rules, or execution mechanics |
...
| Founder uses a named PayPlus work command | Work Command Language and Documentation Development Workflow | Primary owner; applicable procedure, framework, or specialist guide | Mapped canonical lifecycle stage |
...
- A command-interface reference may define command meaning and routing only; it must inherit every stage, gate, owner, and authorization rule from the Documentation Development Workflow.
...
| `docs/documentation-system/` | Documentation operating architecture: this map, canonical lifecycle workflow, command-interface references, optional procedures, and specialist documentation guides |
...
- The Work Command Language may translate a Founder command into a work mode and lifecycle entry or return stage, but the Documentation Development Workflow supplies all lifecycle meaning and authority.
...
Before adding a workflow, procedure, command-interface reference, framework, or specialist guide:
...
2. classify it correctly:
   ...
   - **command-interface reference** for a controlled vocabulary that routes user intent into an existing workflow without owning its stages or gates;
...
5. place operating workflows, procedures, command-interface references, and specialist documentation guides in `docs/documentation-system/`;
