...
A prototype may be listed here only after its scope, source baseline, status, and required validation have been recorded under the PayPlus Prototype Design and Validation Workflow.
