...
| Technical and operational specifications | Active but incomplete for DOC-16 to DOC-25 | DOC-16, DOC-17, DOC-18, DOC-19, DOC-23, DOC-24, and DOC-25 are Stage 9-passed Drafts for technical architecture, the provider-neutral External Interaction Contract, business-recording/explainability, mechanism-neutral security controls, the Engineering Core, recognised-confirmation-to-one-Payment and financial-effect integrity, and Settlement/Payout/reconciliation integrity. DOC-20 to DOC-22 contain substantive Founder Working Baselines. The Engineering Specification Family consumes accepted owner inputs and does not approve technical representation. No source authorizes inferred provider selection or exact API, backend, adapter, schema, event/status taxonomy, credential, security mechanism, implementation, compliance, certification, acceptance, enablement, or readiness. |
...
| `06-engineering/` | Technical architecture, API/integration specifications, business-recording, the Engineering Core, bounded Engineering Specifications, and OpenAPI placeholder. |
...
6. `DOC-16` for the reviewed technical-architecture posture; `DOC-17` for the reviewed provider-neutral External Interaction Contract, Functional-Surface Coverage, and evidence and owner-handoff obligations; `DOC-18` for the reviewed business-recording, explainability, history, lineage, audit-meaning, and owner-handoff contract; `DOC-19` for the reviewed mechanism-neutral security-control contract; and `DOC-20` to `DOC-22` for their substantive acceptance, operations, and Admin baselines. Then read `DOC-23` for the Engineering Core and `DOC-24`/`DOC-25` for their bounded Engineering Specifications; Scenarios and Artefacts remain subordinate and these documents do not replace source owners. DOC-18's exact technical representation, provider selection and exact provider/API/backend/adapter detail remain separately gated, and exact DOC-19 mechanisms remain open under its recorded dependencies and open questions.
