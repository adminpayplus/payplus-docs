...
| Bills tab, obligation management, bill/rent activity, reminder management, evidence source selection, and participant linking | DOC-05, DOC-06, DOC-08, DOC-12, DOC-15 | DOC-18, DOC-19, DOC-20, DOC-22 | Bills route UX review, card/detail/action-required tests, bill/rent activity timeline and activity-detail tests, receipt/proof access tests, linked reminder tests, reminder default/override/delete tests, evidence-source tests, participant-linking privacy tests, no-auto-matching tests, audit-event evidence. |
