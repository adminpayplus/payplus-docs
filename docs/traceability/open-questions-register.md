...
| OQ-XDOC-013 | Bills tab, evidence source selection, and participant linking | Confirm final Bills tab visual layout, evidence-source selection UI, user-initiated payee linking/invitation mechanism, no-auto-matching privacy controls, and technical object/event model. | Product / Design / Privacy / Engineering | DOC-05, DOC-06, DOC-08, DOC-12, DOC-15, DOC-18, DOC-19, DOC-22 | Open |
